...
model {
  ...
  for (s in 1:nS) {
    for (t in 1:nT) {
      ...
      //update value of chosen segment
      value_alpha[choice[s,t]]=value_alpha[choice[s,t]] + reward[s,t];
      value_beta[choice[s,t]]=value_beta[choice[s,t]] - reward[s,t] + 1;
      
      //decay all segment values
      value_alpha[1:num_segments[s,t]]=lambda[s]*value_alpha[1:num_segments[s,t]];
      value_beta[1:num_segments[s,t]]=lambda[s]*value_beta[1:num_segments[s,t]];
